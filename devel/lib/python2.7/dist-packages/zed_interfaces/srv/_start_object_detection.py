...
class start_object_detectionRequest(genpy.Message):
  _md5sum = "50002fd3ef2d2a0c4d9f816ee7272ef8"
...
"""
  __slots__ = ['model','confidence','max_range','tracking','sk_body_fitting','mc_people','mc_vehicles','mc_bag','mc_animal','mc_electronics','mc_fruit_vegetable']
  _slot_types = ['int8','float32','float32','bool','bool','bool','bool','bool','bool','bool','bool']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       model,confidence,max_range,tracking,sk_body_fitting,mc_people,mc_vehicles,mc_bag,mc_animal,mc_electronics,mc_fruit_vegetable
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_b2f8B().pack(_x.model, _x.confidence, _x.max_range, _x.tracking, _x.sk_body_fitting, _x.mc_people, _x.mc_vehicles, _x.mc_bag, _x.mc_animal, _x.mc_electronics, _x.mc_fruit_vegetable))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.model, _x.confidence, _x.max_range, _x.tracking, _x.sk_body_fitting, _x.mc_people, _x.mc_vehicles, _x.mc_bag, _x.mc_animal, _x.mc_electronics, _x.mc_fruit_vegetable,) = _get_struct_b2f8B().unpack(str[start:end])
...
def _get_struct_I():
    ...
    return _struct_I
_struct_b2f8B = None
def _get_struct_b2f8B():
    global _struct_b2f8B
    if _struct_b2f8B is None:
        _struct_b2f8B = struct.Struct("<b2f8B")
    return _struct_b2f8B
# This Python file uses the following encoding: utf-8
...
class start_object_detection(object):
  ...
  _md5sum = 'b995a85771d2d4944e6f5eac75f36055'
