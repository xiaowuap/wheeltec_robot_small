...
if("TRUE" STREQUAL "TRUE")
  set(clear_costmap_recovery_SOURCE_PREFIX /home/wheeltec/wheeltec_robot/src/navigation-melodic/clear_costmap_recovery)
  set(clear_costmap_recovery_DEVEL_PREFIX /home/wheeltec/wheeltec_robot/devel)
  ...
  set(clear_costmap_recovery_INSTALL_PREFIX /home/wheeltec/wheeltec_robot/install)
...
if(NOT "/home/wheeltec/wheeltec_robot/src/navigation-melodic/clear_costmap_recovery/include " STREQUAL " ")
  set(clear_costmap_recovery_INCLUDE_DIRS "")
  set(_include_dirs "/home/wheeltec/wheeltec_robot/src/navigation-melodic/clear_costmap_recovery/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'clear_costmap_recovery' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/wheeltec/wheeltec_robot/src/navigation-melodic/clear_costmap_recovery/${idir}'.  ${_report}")
    endif()
